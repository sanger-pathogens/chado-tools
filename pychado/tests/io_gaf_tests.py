...
class TestGAFExport(unittest.TestCase):
    ...
    @unittest.mock.patch("pychado.io.gaf.GAFExportClient._extract_polypeptide_of_feature")
    @unittest.mock.patch("pychado.io.gaf.GAFExportClient._extract_transcript_of_feature")
    @unittest.mock.patch("pychado.io.gaf.GAFExportClient._extract_gene_of_feature")
    ...
    @unittest.mock.patch("pychado.io.gaf.GAFExportClient.query_parent_features")
    @unittest.mock.patch("pychado.io.gaf.GAFExportClient._extract_feature_type")
    ...
    @unittest.mock.patch("pychado.io.gaf.GAFExportClient.query_child_features")
    @unittest.mock.patch("pychado.io.gaf.GAFExportClient.query_parent_features")
    @unittest.mock.patch("pychado.io.gaf.GAFExportClient._extract_feature_type")
